...
print(gcf,'-dpng','-r600','-painters',['pmaps.png'])
...
faceColors = makesymbolspec('Polygon',...
    {'INDEX', [1 numel(states)], 'FaceColor','none'}); %NOTE - colors are random
 geoshow(lats(bb),lon(aa),reshape(log(1./tmpmap(isgd(bgood),:)),size(aa)), 'DisplayType', 'texturemap')
...
print(gcf,'-dpng','-r600','-painters',['ptest.png'])
